...
import static com.example.myaudioplayer.MainActivity.SONGNAME_TO_FRAG;


public class NowPlayingFragment_bottom extends Fragment implements ServiceConnection {
    ...
    public NowPlayingFragment_bottom() {
        ...
        if(SHOW_MINI_PLAYER) {
            if(PATH_TO_FRAG != null) {
                ...
                if(getContext() != null) {
                    ...
                    isServiceBound = true; // Service is bound
                }
            }
        }
    }
    ...
    public void onPause() {
        ...
        if (isServiceBound && getContext() != null) {
            ...
            isServiceBound = false; // Service is unbound
        }
    }
